package com.grierforensics.greatdane.bc.fetcher;
...
import com.grierforensics.greatdane.bc.DANEEntry;
import com.grierforensics.greatdane.bc.DANEEntryFetcher;
import com.grierforensics.greatdane.bc.DANEEntryFetcherFactory;
import com.grierforensics.greatdane.bc.DANEException;
                ...
                throws DANEException
            {
                ...
                try
                {
                    ...
                    if (domainName.indexOf("_smimecert.") > 0)
                    {
                        ...
                        if (smimeAttr != null)
                        {
                            for (int i = 0; i < smimeAttr.size(); i++) {
                                byte[] data = (byte[]) smimeAttr.get(i);
