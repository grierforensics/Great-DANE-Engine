...
GREATDANEENGINE_CONF="$GREATDANEENGINE_HOME/conf/engine.conf"
GREATDANEENGINE_LOGCONF="$GREATDANEENGINE_HOME/conf/logback.xml"
GREATDANEENGINE_LOGDIR="$GREATDANEENGINE_HOME/logs"
mkdir -p $GREATDANEENGINE_LOGDIR
GREATDANEENGINE_PIDFILE="$GREATDANEENGINE_HOME/greatdaneengine.pid"
...
greatdaneengine_daemon()
{
    $GREATDANEENGINE_JSVC \
        ...
        -Dconfig.file="$GREATDANEENGINE_CONF" \
        -Dlogback.configurationFile="$GREATDANEENGINE_LOGCONF" \
        $1 \
